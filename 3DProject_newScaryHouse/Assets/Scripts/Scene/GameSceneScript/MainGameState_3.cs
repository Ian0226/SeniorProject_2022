...
public class MainGameState_3 : ISceneState
{
    ...
    public override void StateUpdate()
    {
        ...
        if (GameLoop.testInt == 4 && sceneChanged == false)
        {
            MainGame.Instance.SceneTransitionAni(() => m_Controller.SetState(new MainGameState_4(m_Controller), "MainGameScene_4"), false);
            sceneChanged = true;
        }
